...
import GoToPageButton from "../../atoms/go-to-page-button/GoToPageButton";

const ButtonPrevious = lazy(() =>
  import("../../atoms/navigation-buttons/ButtonPrevious"),
);
const ButtonNext = lazy(() =>
  import("../../atoms/navigation-buttons/ButtonNext"),
);
